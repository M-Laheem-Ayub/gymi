    ...
    const goals = [
        {
            id: 'lean',
            title: 'Get Lean',
            desc: 'Burn calories and build muscle to shift your body composition.'
        },
        {
            id: 'muscle',
            title: 'Build Muscle',
            desc: 'Increase muscle mass, strength, and power.'
        },
        {
            id: 'fitness',
            title: 'Improve Fitness',
            desc: 'Boost your functional strength, balance, and flexibility.'
        }
    ];
        ...
        <div className="h-screen w-screen bg-black text-white flex flex-col font-sans overflow-hidden">
            ...
            <div className="px-6 pt-6 pb-2">
                <div className="flex items-center justify-between mb-8">
                    <button onClick={() => navigate('/signup/body')} className="p-2 -ml-2">
                ...
                <div className="flex flex-col gap-4">
                    {goals.map((goal) => (
                        <button
                            ...
                            className={`w-full p-6 text-left rounded-lg transition-all duration-200 flex items-center justify-between group ${selectedGoal === goal.id
                        ...
                        >
                            <div className="flex-1 pr-4">
                                ...
                                <p className={`text-sm leading-relaxed ${selectedGoal === goal.id ? 'text-[#4B5563]' : 'text-[#9CA3AF]'
                                    }`}>
                                    {goal.desc}
                                </p>
                            </div>
                            ...
                            {/* Radio Circle */}
                            <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${selectedGoal === goal.id
                                ? 'border-[#000000]'
                                : 'border-[#4B5563]'
                                }`}>
