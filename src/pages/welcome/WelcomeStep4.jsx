    ...
    return (
        <div className="relative h-screen w-screen overflow-hidden bg-black text-white font-sans">
            <div className="absolute inset-0 z-0">
                <img src="/images/slide4.png" alt="Background" className="h-full w-full object-cover opacity-60" />
            ...
            <div className="absolute inset-0 z-10 flex flex-col justify-between pointer-events-none">
                    ...
                    <AnimatePresence>
                        ...
                        >
                            ...
                            <p className="text-sm leading-relaxed text-gray-200">
                                Gymi tracks your weight, reps, and sets automatically. Analyze your strength growth with detailed insights on your mobile app.
                            </p>
                        </motion.div>
                    </AnimatePresence>
                </div>
                ...
                <div className="flex justify-center space-x-2 mb-8 pointer-events-auto">
                    {[1, 2, 3, 4, 5].map((step) => (
                        <div key={step} className={`h-1 rounded-full transition-all duration-300 ${step === 4 ? 'w-8 bg-white' : 'w-4 bg-gray-600'}`} />
                    ))}
                </div>
            ...
            <div className="absolute inset-y-0 left-0 w-1/3 z-20 cursor-pointer" onClick={() => navigate('/welcome/3')} />
            <div className="absolute inset-y-0 right-0 w-1/3 z-20 cursor-pointer" onClick={() => navigate('/welcome/5')} />
        </div>
    );
};
